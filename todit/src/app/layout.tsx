...
export const metadata: Metadata = {
  ...
  keywords: ["투딧", "ToDit", "To-Do", "할일", "할일관리", "할일생성", "할일추천", "할일목록", "이미지 todo", "수행평가 todo", "학교생활 todo", "업무 todo", "이미지 todo", "이미지 투두", "사진으로 계획", "수행평가 계획", "자동 일정 생성기", "투딧 라이트", "todit lite", "투딧", "ToDit", "To-Do", "할일", "할일관리", "할일생성", "할일추천", "할일목록", "이미지 todo", "수행평가 todo", "학교생활 todo", "업무 todo", "이미지 todo", "이미지 투두", "사진으로 계획", "수행평가 계획", "자동 일정 생성기"],
  icons: {
    icon: "/favicon.png",
