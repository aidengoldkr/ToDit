    ...
    <div className={styles.container}>
      <div className={styles.content}>
        ...
        <section className={styles.section}>
          <h2>제4조 (플랜 및 결제)</h2>
          <p>
            서비스는 Free 플랜과 Pro 플랜을 제공합니다. Pro 플랜은 별도의 업그레이드 및 결제 절차를 통해
            이용할 수 있으며, 제공 기능과 가격은 서비스 화면 또는 별도 안내에 따릅니다.
          </p>
          <p>
            결제 처리는 PG사 또는 결제 파트너를 통해 진행될 수 있으며, 서비스는 결제 승인 결과, 플랜 상태,
            이용 기간과 같이 운영에 필요한 범위의 정보만 반영합니다.
          </p>
        </section>
